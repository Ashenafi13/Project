...
FROM         user INNER JOIN
                      student_request ON user.Student_ID = student_request.Student_ID where student_request.Request_Status='Inprocess' and user.Program='Regular'";
...
FROM         user INNER JOIN
  ...
  $result1 = mysqli_query($connect, $query);
      ...
      //Student business affairs
         $query = "SELECT request_approve.Approve_ID, user.Full_name,user.Institute,user.Program,request_approve.Student_ID,student_request.Reason,student_request.Last_Class_Attend,student_request.Request_type,request_approve.Approved_By,offices.office_name,request_approve.Approved_Date
FROM         user INNER JOIN
                      student_request ON user.Student_ID = student_request.Student_ID INNER JOIN request_approve ON user.Student_ID =request_approve.Student_ID INNER JOIN offices ON request_approve.Approved_Office=offices.office_id where request_approve.Approved_Office='2' and user.Program='Regular' and request_approve.Status='Inprocess' OR request_approve.Approved_Office='2' and request_approve.Status='Approved'";
  $result1 = mysqli_query($connect, $query);
      ...
      //tools center
         $query = "SELECT request_approve.Approve_ID, user.Full_name,user.Institute,user.Program,request_approve.Student_ID,student_request.Reason,student_request.Last_Class_Attend,student_request.Request_type,request_approve.Approved_By,offices.office_name,request_approve.Approved_Date
FROM         user INNER JOIN
                      student_request ON user.Student_ID = student_request.Student_ID INNER JOIN request_approve ON user.Student_ID =request_approve.Student_ID INNER JOIN offices ON request_approve.Approved_Office=offices.office_id where request_approve.Approved_Office='4' and user.Program='Regular' and request_approve.Status='Inprocess' OR request_approve.Approved_Office='4' and request_approve.Status='Approved'";
  $result1 = mysqli_query($connect, $query);
      ...
      //tools center
         $query = "SELECT request_approve.Approve_ID, user.Full_name,user.Institute,user.Program,request_approve.Student_ID,student_request.Reason,student_request.Last_Class_Attend,student_request.Request_type,request_approve.Approved_By,offices.office_name,request_approve.Approved_Date
FROM         user INNER JOIN
                      student_request ON user.Student_ID = student_request.Student_ID INNER JOIN request_approve ON user.Student_ID =request_approve.Student_ID INNER JOIN offices ON request_approve.Approved_Office=offices.office_id where request_approve.Approved_Office='5' and user.Program='Regular' and request_approve.Status='Inprocess' OR request_approve.Approved_Office='5' and request_approve.Status='Approved'";
  $result1 = mysqli_query($connect, $query);
      ...
      //Registrar
         $query = "SELECT request_approve.Approve_ID, user.Full_name,user.Institute,user.Program,request_approve.Student_ID,student_request.Reason,student_request.Last_Class_Attend,student_request.Request_type,request_approve.Approved_By,offices.office_name,request_approve.Approved_Date
FROM         user INNER JOIN
                      student_request ON user.Student_ID = student_request.Student_ID INNER JOIN request_approve ON user.Student_ID =request_approve.Student_ID INNER JOIN offices ON request_approve.Approved_Office=offices.office_id where request_approve.Approved_Office='6' and user.Program='Regular' and request_approve.Status='Inprocess' OR request_approve.Approved_Office='6' and request_approve.Status='Approved'";
  $result1 = mysqli_query($connect, $query);
      ...
      <li class="nav-item">
       ...
       <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
            ...
            <a class="dropdown-item active" href="ViewRequest.php">Regular student</a>
