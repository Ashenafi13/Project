...
<!--===============================================================================================-->	
    ...
    <body style="background-color: #cccccc;">
        <div class="alert alert-success" role="alert" style="color: #000; font-size: 20px; width: 50%; height: 50%;margin-top: 6%;margin-left: 20%; " >
               
               The Request Rejected successfully
                 
          <hr class="my-4">
 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter" onclick="window.location = 'ViewRequestPostgradualte.php'">
 Back
</button>       
     </div>
    </body>
